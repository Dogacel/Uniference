...
class Llama3:
    ...
    def build(
        ...
        if not model_parallel_is_initialized():
            ...
            print(f"Initializing model parallel with world size {world_size}")
        ...
        if me.world.backend == "pytorch":
            ...
            new_mp_size = len(me.world.devices)
            new_mp_rank = me.world.devices.index(me)
